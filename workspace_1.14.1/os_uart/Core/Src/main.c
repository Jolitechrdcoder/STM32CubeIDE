...
osThreadId uart33Handle;
osThreadId bombillosHandle;
/* USER CODE BEGIN PV */
...
/* USER CODE BEGIN Header_Startuart33 */
/**
  * @brief  Function implementing the uart33 thread.
...
/* USER CODE BEGIN Header_Startbombillos */
/**
* @brief Function implementing the bombillos thread.
* @param argument: Not used
* @retval None
*/
