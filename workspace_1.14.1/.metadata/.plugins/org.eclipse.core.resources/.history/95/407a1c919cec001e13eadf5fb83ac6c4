...
osThreadId adc2Handle;
osThreadId lcd2Handle;
osThreadId keypad2Handle;
osThreadId matriz2Handle;
osThreadId sonic2Handle;
/* USER CODE BEGIN PV */
...
/* USER CODE BEGIN Header_Startadc2 */
/**
  * @brief  Function implementing the adc2 thread.
...
/* USER CODE BEGIN Header_Startlcd2 */
/**
* @brief Function implementing the lcd2 thread.
* @param argument: Not used
* @retval None
*/
...
void Startlcd2(void const * argument)
{
  ...
  /* USER CODE END Startlcd2 */
}

/* USER CODE BEGIN Header_Startkeypad2 */
/**
* @brief Function implementing the keypad2 thread.
* @param argument: Not used
* @retval None
*/
...
void Startkeypad2(void const * argument)
{
  ...
  /* USER CODE END Startkeypad2 */
}

/* USER CODE BEGIN Header_Startmatriz2 */
/**
* @brief Function implementing the matriz2 thread.
* @param argument: Not used
* @retval None
*/
...
void Startmatriz2(void const * argument)
{
  ...
  /* USER CODE END Startmatriz2 */
}

/* USER CODE BEGIN Header_Startsonic2 */
/**
* @brief Function implementing the sonic2 thread.
* @param argument: Not used
* @retval None
*/
