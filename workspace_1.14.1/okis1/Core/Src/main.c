...
osThreadId adc223Handle;
osThreadId lcd33Handle;
/* USER CODE BEGIN PV */
uint32_t Medida_ADC;
/* USER CODE END PV */
...
/* USER CODE BEGIN Header_Startadc223 */
/**
  * @brief  Function implementing the adc223 thread.
...
/* USER CODE BEGIN Header_Startlcd33 */
/**
* @brief Function implementing the lcd33 thread.
* @param argument: Not used
* @retval None
*/
