...
#define Time_ADC    100
#define Time_matriz 1050
#define Time_sonic  2000
/* USER CODE END PM */
...
void TASK_ULTRASONICO(){
	uint16_t Distance =  ultrasonido_medir_distancia();
	 lcd_clear();
			  	        lcd_put_cur(1, 6);
